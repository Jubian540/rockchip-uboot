cmd_tools/proftool := cc -Wp,-MD,tools/.proftool.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -include /data/build/android-rk3399-Industry/u-boot/include/libfdt_env.h -idirafterinclude -idirafter/data/build/android-rk3399-Industry/u-boot/arch/arm/include -I/data/build/android-rk3399-Industry/u-boot/lib/libfdt -I/data/build/android-rk3399-Industry/u-boot/tools -DCONFIG_SYS_TEXT_BASE=0x00200000 -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -o tools/proftool tools/proftool.c  
