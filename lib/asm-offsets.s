...
// -I /data/build/android-rk3399-Industry/u-boot/arch/arm/include
// -iprefix /data/build/android-rk3399-Industry/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9/
// -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x00200000 -D __ARM__
// -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
// -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
// -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
// -isystem /data/build/android-rk3399-Industry/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/../lib/gcc/aarch64-linux-android/4.9/include
// -include /data/build/android-rk3399-Industry/u-boot/include/linux/kconfig.h
...
.ascii "->PM_CTX_PHYS 432 offsetof(struct global_data, pm_ctx_phys)"	//
// 0 "" 2
	.loc 1 49 0
#NO_APP
	mov	w0, 0	//,
...
.LFE157:
	...
	.text
.Letext0:
	.file 2 "/data/build/android-rk3399-Industry/u-boot/arch/arm/include/asm/types.h"
...
.LASF13:
	.string	"start"
.LASF58:
	.string	"/data/build/android-rk3399-Industry/u-boot"
.LASF18:
	.string	"bi_flashsize"
.LASF24:
	.string	"bi_ddr_freq"
